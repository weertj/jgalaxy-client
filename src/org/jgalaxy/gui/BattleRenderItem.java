...
public class BattleRenderItem extends JavelinUIElement {

  public BattleRenderItem(String id, Object element, ISP_Position position) {
  ...
  @Override
  public ISB_BattleReport element() {
    return (ISB_BattleReport) super.element();
  }
  ...
  public void render(IJavelinCanvas pCanvas, IJL_PlayerContext pContext) {
    ...
    List<Color> colors = Colors.battleColorsFor(element());
